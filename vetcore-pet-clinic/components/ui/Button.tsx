...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-primary hover:bg-primary-light text-white shadow-lg shadow-primary/30 focus:ring-primary',
    secondary: 'bg-secondary hover:bg-yellow-400 text-white shadow-lg shadow-secondary/30 focus:ring-secondary',
